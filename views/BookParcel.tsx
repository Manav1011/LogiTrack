...
export const BookParcel: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    createParcel({
      ...
      sourceOfficeId: currentUser?.officeId || '',
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
               <div className="md:col-span-2">
                  <InputGroup label="Content Description">
                      <StyledInput required value={form.type} onChange={e => setForm({...form, type: e.target.value})} placeholder="e.g. Documents, Electronics" />
                  </InputGroup>
               </div>
               <InputGroup label="Weight (kg)">
                  <StyledInput type="number" required value={form.weightKg} onChange={e => setForm({...form, weightKg: e.target.value})} />
               </InputGroup>
               <InputGroup label="Quantity">
                  <StyledInput type="number" min="1" required value={form.quantity} onChange={e => setForm({...form, quantity: e.target.value})} />
               </InputGroup>
               <div className="md:col-span-2">
